...
from .deepsort_utils import load_classes

def DeepSORT_system(videopath, frameQueue, detections_queue, result_queue, allow_tracker, end_detector, end_tracker,dataset_metadata_catalog, detector_ready,fps,img_scale_percent,tracker_ready):
    ...
    dim = (width, height)
    ###################################
    result = cv2.VideoWriter(f"deepsort-scale{img_scale_percent}-{fps}fps.avi", 
