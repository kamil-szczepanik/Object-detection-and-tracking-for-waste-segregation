...
import cv2
import time
from .sort_utils import load_classes
from detectron2.utils.video_visualizer import VideoVisualizer
from detectron2.utils.visualizer import ColorMode


def SORT_system(videopath, frameQueue, detections_queue, result_queue, allow_tracker, end_detector, end_tracker,dataset_metadata_catalog,detector_ready,fps,img_scale_percent,tracker_ready):
